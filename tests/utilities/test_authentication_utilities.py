...
from github_organization_repo_explorer.utilities.authentication_utilities import get_personal_access_token, PERSONAL_ACCESS_TOKEN_KEY

class TestAuthenticationUtilities(unittest.TestCase):
    @patch("github_organization_repo_explorer.utilities.authentication_utilities.get_key")
    ...
    @patch("github_organization_repo_explorer.utilities.authentication_utilities.get_key")
    @patch("github_organization_repo_explorer.utilities.authentication_utilities._prompt_for_personal_access_token")
    @patch("github_organization_repo_explorer.utilities.authentication_utilities.set_key")
    @patch("github_organization_repo_explorer.utilities.authentication_utilities.DOTENV_PATH")
